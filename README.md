...
#### THIS REPOSITORY IS A FORK VERSION OF THE DOCKER-LINUXSERVER.IO
#### THIS REPOSITORY CONTAIN SOME ADDITIONNAL TOOLS LIKE TESSERACT OCR AND CAN BE USED WITH THE ELASTIC-NEXTCLOUD FOR FULLTEXT SEARCH.
